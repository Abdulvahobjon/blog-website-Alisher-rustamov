...
export default function Home() {
  const [currentHomeBottom, setCurrentHomeBottom] = useState(4);
  const [postsPerHomeBottom, setPostsPerHomeBottom] = useState(8);
  const currentPostsBottom = data.slice(currentHomeBottom, postsPerHomeBottom);
  const [currentHomeTop, setCurrentHomeTop] = useState(0);
  const [postsPerHomeTop, setPostsPerHomeTop] = useState(4);
  const currentPostsTop = data.slice(currentHomeTop, postsPerHomeTop);
  return (
    <div>
